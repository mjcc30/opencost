...
// PipelineService is a storage agnostic implementation of the PipelineController interface
...
// NewDefaultPipeline is a constructor for the DefaultPipeline struct
